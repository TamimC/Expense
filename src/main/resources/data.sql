insert into user values(1, 'Siamak', 'Siamak@gmail.com' )
insert into user values(2, 'Tamim', 'Siamak@gmail.com' )
insert into user values(3, 'Patricia', 'Siamak@gmail.com' )

insert into category values (1, 'Food')
insert into category values (2, 'Car')
insert into category values (3, 'Entertainment')
insert into category values (4, 'Work')
